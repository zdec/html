...
function loadHeader() {
            ...
            if (inputElement && resultsElement && formElement) {
                ...
                formElement.addEventListener('submit', function(e) {
                    ...
                    if (query.length >= 2) {
                        ...
                        if (firstResult) {
                            const url = firstResult.getAttribute('data-product-url');
                ...
                inputElement.addEventListener('keydown', function(e) {
                    ...
                    if (e.key === 'ArrowDown') {
                        ...
                        e.preventDefault();
                        const url = selectedItem.getAttribute('data-product-url');
                        if (url) window.location.href = url;
    ...
    function displayResults(results, query, container) {
        ...
        results.forEach(product => {
            ...
            html += `
                <div class="search-result-item" data-product-url="${productUrl}">
