                    ...
                    <div class="product">
                        ...
                        <div class="thumb">
                            <a href="${productUrl}" class="image">
                                <img src="${imgSrc}" alt="${product.alt || product.title}" />
                                <img class="hover-image" src="${imgSrc}" alt="${product.alt || product.title}" />
                            </a>
                        </div>
                        <div class="content">
                            <span class="category"><a href="${productUrl}">${product.category}</a></span>
