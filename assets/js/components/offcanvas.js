...
function loadOffcanvas() {
    const offcanvasHTML = `
        ...
        <div id="offcanvas-wishlist" class="offcanvas offcanvas-wishlist">
            <div class="inner">
                <div class="head">
                    <span class="title">${SiteConfig.texts.wishlistText}</span>
                    ...
                    <ul class="minicart-product-list">
                        <li>
                            <a href="single-product.html" class="image">
                                <img src="assets/images/product-image/1.webp" alt="Antena Satelital">
                            </a>
                            <div class="content">
                                <a href="single-product.html" class="title">Antena Satelital</a>
                                <span class="quantity-price">1 x <span class="amount">$9'800.000</span></span>
                ...
                <div class="foot">
                    <div class="buttons">
                        <a href="#" realhref="wishlist.html" class="btn btn-dark btn-hover-primary mt-30px">Ver lista de favoritos</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="offcanvas-mobile-menu" class="offcanvas offcanvas-mobile-menu">
            ...
            <div class="user-panel">
                <ul>
                    ...
                    <li><a href="#"><i class="fa fa-user"></i> ${SiteConfig.texts.accountText}</a></li>
                </ul>
            </div>
            <div class="inner customScroll">
                ...
                <div class="offcanvas-social mt-auto">
                    <ul>
                        <li>
                            <a href="${SiteConfig.social.facebook}"><i class="fa fa-facebook"></i></a>
                        </li>
                        <li>
                            <a href="${SiteConfig.social.twitter}"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li>
                            <a href="${SiteConfig.social.tumblr}"><i class="fa fa-google"></i></a>
                        </li>
                        <li>
                            <a href="${SiteConfig.social.youtube}"><i class="fa fa-youtube"></i></a>
                        </li>
                        <li>
                            <a href="${SiteConfig.social.instagram}"><i class="fa fa-instagram"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    if (header) {
        ...
        if (mainWrapper) {
            mainWrapper.insertAdjacentHTML('afterbegin', offcanvasHTML);
        } else {
